(defmacro with-html ((&key title) &body body)
  `(cl-who:with-html-output-to-string 
	 ...
	 (:script :src "https://cdn.bootcdn.net/ajax/libs/crypto-js/3.1.2/components/core.js")
	 (:script :src "https://cdn.bootcdn.net/ajax/libs/crypto-js/3.1.2/components/enc-base64.js")
	 (:script :src "https://cdn.bootcdn.net/ajax/libs/crypto-js/3.1.2/components/md5.js")
	 (:script :src "https://cdn.bootcdn.net/ajax/libs/jsencrypt/2.1.0/jsencrypt.min.js")
	 (:script :src "https://cdn.bootcdn.net/ajax/libs/jquery-validate/1.10.0/jquery.validate.min.js")
	 (:script :src "https://cdn.bootcdn.net/ajax/libs/jquery-validate/1.10.0/localization/messages_zh.min.js")
